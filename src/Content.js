      ...
      <div>
        <div className={homeClasses}>
          <div className={social}>
            <ul>
              <li><a href="https://www.linkedin.com/joffrey-weertz/">LinkedIn</a></li>
              <li><a href="https://github.com/jSUNSH1NEw">GitHub</a></li>
            </ul>
          </div>
        ...
        <div className={aboutProjectClasses}>
          <div className={aboutBox}>
            <h1>Already working on personnal project, im  a enthusiast freelancer, i do <span className={highlight}>Creatif content</span>  <span className={highlight}>, Automatise Deployment</span>, <span className="highlight">web application solutions.</span> </h1>
            <br />
            <ul>{ skillsList }</ul>
          </div>
